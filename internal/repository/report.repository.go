...
type ReportRepository interface {
	GetDailySalesReport(date string) (*response.DailyReportResponse, error)
	GetMonthlySalesReport(year, month int) (*response.MonthlyReportResponse, error)
}
...
func (r *reportRepository) GetDailySalesReport(date string) (*response.DailyReportResponse, error) {
	...
	// Per film
	var byMovie []response.MovieSalesReport
	r.db.Raw(`
		SELECT
	...
	// Per studio
	var byStudio []response.StudioSalesReport
	r.db.Raw(`
		SELECT
...
func (r *reportRepository) GetMonthlySalesReport(year, month int) (*response.MonthlyReportResponse, error) {
	// Total
	type total struct {
		Count   int
		Revenue float64
