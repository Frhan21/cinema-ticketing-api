...
type ScheduleService interface {
	...
	Create(req CreateSchedule) (entities.Schedule, error)
	Update(id uuid.UUID, req UpdateSchedule) (entities.Schedule, error)
...
func (s *scheduleService) Create(req CreateSchedule) (entities.Schedule, error) {
...
func (s *scheduleService) Update(id uuid.UUID, req UpdateSchedule) (entities.Schedule, error) {
	schedule, err := s.scheduleRepo.FindByID(id)
	if err != nil {
		return entities.Schedule{}, err
	}
...
func NewScheduleService(scheduleRepo ScheduleRepository) ScheduleService {
