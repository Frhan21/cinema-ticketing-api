...
type ReportRepository interface {
	GetDailySalesReport(date string) (*reportdto.DailyReportResponse, error)
	GetMonthlySalesReport(year, month int) (*reportdto.MonthlyReportResponse, error)
}
...
func (r *reportRepository) GetDailySalesReport(date string) (*reportdto.DailyReportResponse, error) {
	...
	// Per film
	var byMovie []reportdto.MovieSalesReport
	r.db.Raw(`
		SELECT
	...
	// Per studio
	var byStudio []reportdto.StudioSalesReport
	r.db.Raw(`
		SELECT
	...
	return &reportdto.DailyReportResponse{
		Date:             date,
...
func (r *reportRepository) GetMonthlySalesReport(year, month int) (*reportdto.MonthlyReportResponse, error) {
	// Total
	type total struct {
		Count   int
		Revenue float64
	...
	// Breakdown harian
	var daily []reportdto.DailySales
	r.db.Raw(`
		SELECT
