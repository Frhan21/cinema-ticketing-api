...
type UserService interface {
	...
	UpdateProfile(id string, input UpdateUserRequest) (*entities.User, error)
}
...
func (s *userService) UpdateProfile(id string, input UpdateUserRequest) (*entities.User, error) {
	parsedID, err := uuid.Parse(id)
	if err != nil {
		return nil, apperror.NewBadRequestError("invalid user id")
	}
