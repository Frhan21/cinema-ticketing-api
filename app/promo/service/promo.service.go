...
import (
	promodto "cinema-ticketing-api/app/promo/dto"
...
type PromoService interface {
	Create(req promodto.CreatePromoRequest) (*entities.Promo, error)
	...
	Update(id uuid.UUID, req promodto.UpdatePromoRequest) (*entities.Promo, error)
	Delete(id uuid.UUID) error
}

type promoService struct {
	promoRepo promorepository.PromoRepository
}

func NewPromoService(promoRepo promorepository.PromoRepository) PromoService {
	return &promoService{promoRepo: promoRepo}
}

func (s *promoService) Create(req promodto.CreatePromoRequest) (*entities.Promo, error) {
	// Cek duplikat kode
...
func (s *promoService) Update(id uuid.UUID, req promodto.UpdatePromoRequest) (*entities.Promo, error) {
	promo, err := s.promoRepo.FindByID(id)
	if err != nil {
		return nil, apperror.NewNotFoundError("promo not found")
	}
